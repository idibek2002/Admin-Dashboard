...
import { axiosLogin, saveToken } from '../../utils/token';
...
const SignIn = () => {
  ...
  return (
    <>
      <div className="rounded-sm border w-full h-screen border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex items-center justify-center">
          ...
          <div className="flex gap-9 lg:w-1/2 w-full lg:pr-[30px] pr-0 items-center justify-center h-screen">
            <div className="w-[80%] rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
